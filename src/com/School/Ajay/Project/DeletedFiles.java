...
public class DeletedFiles {
	...
	public void writeBackInFileForTeacher() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("c:\\\\Users\\\\Miles\\\\Desktop\\\\LabProject\\\\teacher.txt"));
			for(Teachers ob : teacherList) {
	...
	public void writeBackInFileForClasses() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("c:\\\\Users\\\\Miles\\\\Desktop\\\\LabProject\\\\class.txt"));
	...
	public void writeBackInFileForSubjects() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("c:\\\\Users\\\\Miles\\\\Desktop\\\\LabProject\\\\subject.txt"));
	...
	public void teacherNamesFromFile() {
		...
		try {
			reader = new BufferedReader(new FileReader(
					"c:\\\\\\\\Users\\\\\\\\Miles\\\\\\\\Desktop\\\\\\\\LabProject\\\\\\\\teacher.txt"));
			String line = reader.readLine();
			while (line != null) {
				Teachers teacher = new Teachers(line);
